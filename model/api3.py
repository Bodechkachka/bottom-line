...
print(get(f'http://127.0.0.1:5000/api3', json={'island': island, 'bill_length_mm': bill_length_mm, 'bill_depth_mm': bill_depth_mm, 'flipper_length_mm': flipper_length_mm, 'body_mass_g': body_mass_g, 'year': year}).json())